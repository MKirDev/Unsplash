package com.mkirdev.unsplash.content_creation.impl
...
@Composable
fun ContentCreationScreen(text: String) {
...
@Preview
@Composable
internal fun ContentCreationScreenPreview() {
    UnsplashTheme(dynamicColor = false) {
        ContentCreationScreen(stringResource(R.string.content_creation))
    }
}